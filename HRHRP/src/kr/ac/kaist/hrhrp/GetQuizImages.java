...
public class GetQuizImages {
	...
	public static HashMap<String, ArrayList<Image>> getImagesTemplate1(String ownerId) {
	...
	public static HashMap<String, ArrayList<Image>> getImagesTemplate2(String ownerId) {
		HashMap<String, ArrayList<Image>> quizImages = new HashMap<String, ArrayList<Image>>();
